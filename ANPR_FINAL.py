...
states = {"AN": "Andaman and Nicobar", "AP": "Andhra Pradesh", "AR": "Arunachal Pradesh", "AS": "Assam",
          ...
          "NL": "Nagaland", "OD": "Odissa", "PY": "Pondicherry", "PN": "Punjab", "RJ": "Rajasthan", "SK": "Sikkim",
          "TN": "TamilNadu", "TR": "Tripura", "UP": "Uttar Pradesh", "WB": "West Bengal", "CG": "Chhattisgarh",
...
def extract_num(img_name):
    ...
    for (x, y, w, h) in nplate:
        ...
        try:
            ...
            print('Car is from : ', states[stat])

        except Exception:
            print('Unable to recognize state ! ')
...
extract_num(r"C:\Users\zainz\Downloads\ANPR\06.jpeg")
